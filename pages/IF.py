...
st.markdown('<h1>Imprinting Factor Predictor</h1>', unsafe_allow_html=True)
st.markdown('<h2>Predict IF Value from SMILES and Concentrations</h2>', unsafe_allow_html=True)
