...
# Streamlit UI setup
st.title("🔬 SMILES Fetcher from PubChem")
st.markdown(
    """
    <style>
...
# Add some content on top of the background
st.markdown("<h2>Enter a compound name to get its SMILES </h2>", unsafe_allow_html=True)
